...
Dataset telah disediakan dalam format CSV agar lebih mudah digunakan untuk dokumentasi dan analisis data.
...
Hasil bootstrapping yang tersedia menunjukkan:
...
Berdasarkan output yang tersedia, pada tingkat signifikansi 5% hubungan dengan nilai p-value di bawah 0.05 dikategorikan signifikan, sedangkan hubungan dengan p-value 0.05 atau lebih tidak signifikan.

### Dokumentasi Output Direct Effects
...
### Dokumentasi Output Total Effects

![Bootstrapping Total Effects](bootstrapping-total-effects.png)

## Catatan Interpretasi

Output menunjukkan adanya perbedaan antara **direct effect** dan **total effect** pada hubungan tertentu.

Sebagai contoh, hubungan **Motivasi Kerja → Kinerja Karyawan** memiliki:

- Direct effect = **0.126**
- P-value direct effect = **0.066**
- Total effect = **0.452**
- P-value total effect = **0.000**

Perbedaan tersebut menunjukkan bahwa jalur tidak langsung dalam model ikut berkontribusi terhadap total effect.

Namun, kesimpulan khusus mengenai **mediasi** belum dituliskan pada project ini karena output **Specific Indirect Effects** belum tersedia dalam file yang diberikan.
...
Project ini merupakan bagian dari portfolio **SPSS / SEM-PLS — Statistical Analysis**.

Project ini didokumentasikan berdasarkan dataset, model SEM-PLS, visualisasi model, dan output bootstrapping yang tersedia.
